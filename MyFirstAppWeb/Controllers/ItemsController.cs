...
namespace MyFirstAppWeb.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public ItemsController(MyFirstAppWebContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id_item,Codigo,Descricao,Preco")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_item,Codigo,Descricao,Preco")] Item item)
        {
            if (id != item.Id_item)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MyFirstAppWebContext.Item'  is null.");
            }
            var item = await _context.Item.FindAsync(id);
            if (item != null)
            {
        ...
        {
          return (_context.Item?.Any(e => e.Id_item == id)).GetValueOrDefault();
        }
    }
}
